...
var ChevronDown = React.createClass({
    ...
    render: function() {
        return (
            <svg className="tilt-images tilt-chevron-down" width={this.props.width} height={this.props.height} viewBox="0 0 10 6" version="1.1">
                <title>chevron_down</title>
                <defs></defs>
                <g id="Page-1" stroke="none" strokeWidth="1" fillRule="evenodd">
                    <g transform="translate(-1132.000000, -25.000000)">
