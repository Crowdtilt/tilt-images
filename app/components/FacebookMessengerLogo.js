...
module.exports = React.createClass({
  ...
  render() {
    const classes = classnames('tilt-icon tilt-icon-facebook-messenger-logo', this.props.className);

    return <svg className={classes} viewBox="0 0 20 18">
      <title>FacebookMessengerLogo</title>
      <g stroke="none" strokeWidth="1" fill="none">
        <g className="facebook-messenger-logo-cloud" transform="translate(-777.000000, -584.000000)" fill="#00A0D8">
          <g transform="translate(768.664153, 576.000000)">
